...
//    }
    ...
    public void testContains() {
        ...
        bag.putItem((new Book("Rejtő Jenő", "Az ellopott cirkáló")));
        //Then
        assertThat(bag.contains(new Beer("Borsodi", 239)), is(true)); // nem lehet false
        assertThat(bag.contains(new Book("Rejtő Jenő", "Az ellopott cirkáló")), is(true));
        assertThat(bag.contains(new Book("Rejtő Jenő", "A megkerült cirkáló")), is(false)); // nem lehet true;
    }
}